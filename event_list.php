    ...
    <div class="container">
        ...
        <table>
            ...
            <?php
                ...
                $query = "SELECT e.id, e.title, e.event_date, e.start_time, e.end_time FROM events e JOIN event_attendance ea ON e.id = ea.event_id WHERE ea.user_id = ?";
        ...
        <div class="event-list">
            ...
            <?php
                require 'connecting/connect.php';
                $query = "SELECT e.id, e.title, e.event_date, e.description, (SELECT COUNT(*) FROM event_attendance ea WHERE ea.event_id = e.id) AS attendee_count FROM events e ORDER BY e.event_date DESC LIMIT 5";
